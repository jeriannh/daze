      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="w-full bg-grey rounded-lg p-8 flex flex-col gap-8">
          <div className="flex flex-row items-center gap-6">
            ...
            <Link 
              ...
              onClick={localStorage.setItem("day", "1")} to="/reflection">
              Journal
            </Link>          
            </div>
          <Video
        ...
        <div className="w-full bg-grey rounded-lg p-8 flex flex-col gap-8">
          <div className="flex flex-row items-center gap-6">
            ...
            <Link 
              className = "rounded-full bg-blue text-white px-5 py-2 hover:shadow-lg"
              onClick={localStorage.setItem("day", "2")} to="/reflection">
              Journal
            </Link>          
            </div>
            {/* put videos here */}
        ...
        <div className="w-full bg-grey rounded-lg p-8 flex flex-col gap-8">
          <div className="flex flex-row items-center gap-6">
            ...
            <Link 
              className = "rounded-full bg-blue text-white px-5 py-2 hover:shadow-lg"
              onClick={localStorage.setItem("day", "3")} to="/reflection">
              Journal
            </Link>          
            </div>
        ...
        <div className="w-full bg-grey rounded-lg p-8 flex flex-col gap-8">
          <div className="flex flex-row items-center gap-6">
            ...
            <Link 
              className = "rounded-full bg-blue text-white px-5 py-2 hover:shadow-lg"
              onClick={localStorage.setItem("day", "4")} to="/reflection">
              Journal
            </Link>          
            </div>
          {/* put here */}
        ...
        <div className="w-full bg-grey rounded-lg p-8 flex flex-col gap-8">
          <div className="flex flex-row items-center gap-6">
            ...
            <Link 
              className = "rounded-full bg-blue text-white px-5 py-2 hover:shadow-lg"
              onClick={localStorage.setItem("day", "5")} to="/reflection">
              Journal
            </Link>          
            </div>
            <Video
        ...
        <div className="w-full bg-grey rounded-lg p-8 flex flex-col gap-8">
          <div className="flex flex-row items-center gap-6">
            ...
            <Link 
              className = "rounded-full bg-blue text-white px-5 py-2 hover:shadow-lg"
              onClick={localStorage.setItem("day", "6")} to="/reflection">
              Journal
            </Link>          
            </div>
          {/* ahhhh */}
        ...
        <div className="w-full bg-grey rounded-lg p-8 flex flex-col gap-8">
          <div className="flex flex-row items-center gap-6">
            ...
            <Link 
              className = "rounded-full bg-blue text-white px-5 py-2 hover:shadow-lg"
              onClick={localStorage.setItem("day", "7")} to="/reflection">
              Journal
            </Link>          
            </div>
          {/* ahhhh */}
