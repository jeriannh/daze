...
export default function Progress() {
  return (
    <div class="w-full px-24 py-6 flex flex-col gap-4">
      ...
      <div className="mt-3 mb-1 text-1xl text-blue text-left">Here at Daze, we believe in celebrating our success and acknowledging our emotions. Sometimes life is difficult and it’s easy to get carried away with our thoughts. Through the reflections you inputted throughout the week, our Natural Language Processing Sentiment Analysis analyzes how you’re feeling. This way you can not only track the highs in life but also the lows as well.</div>
      <div className=" italic mb-6 text-1xl font-pn-bold text-blue text-left"> Feelings are much like waves, we can't stop them from coming but we can choose which one to surf.</div>
